...
const appendBubblesToMap = (
  ...
  Promise.all([d3.json(__WEBPACK_IMPORTED_MODULE_0__util__["d" /* nycMap */]), d3.csv(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* salesVolumeCSV */])]).then((promises) => {
    ...
    if (borough === "Staten Island") {
      ...
      sorrySI.textContent =
        "Oops, we don't have any historical sales volume data by neighborhood for Staten Island yet. Sorry for the inconvenience! 🥺";
